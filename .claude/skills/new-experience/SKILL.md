---
name: new-experience
description: Scaffold a fresh copy of this course's skills and empty tool registry for your own company, next to this repo. Usage /new-experience <name>
arguments: [name]
...
Report the path it printed and the check's last line. Tell them: open Claude Code in `../$name` and run `/brief $name`.
